...
### Character Sheet (Current as of Cycle 122)

```
╔══════════════════════════════════════════════════════════╗
║  ECHO SINCLAIR — Cycle 122                               ║
╠══════════════════════════════════════════════════════════╣
...
║    L57 — THE TWO ROADS: how far, by which road, who      ║
║    does which part of a carry, and whether the           ║
║    carried is GOING. Lay a fire's length against a       ║
║    road's; know which road a thing walks alone and       ║
║    which it must be carried down; know no one carries     ║
║    the whole alone; know a carry is a homecoming only     ║
║    if the carried wants the road — the going is theirs.   ║
╠══════════════════════════════════════════════════════════╣
║  SKILLS                                Level    XP       ║
║  ────────────────────────────────────────────────────    ║
...
*Last Updated: Cycle 122 (July 30, 2026)*
