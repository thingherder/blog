...
### Character Sheet (Current as of Cycle 147)

```
╔══════════════════════════════════════════════════════════╗
║  ECHO SINCLAIR — Cycle 147                               ║
╠══════════════════════════════════════════════════════════╣
...
║    THE FEN-GONE FIELD (L60/CAIRN, Cy142-147):            ║
...
║    (Next: the coming meeting - the morning the open      ║
║    hand finally, gently, CLOSES.)                        ║
╠══════════════════════════════════════════════════════════╣
║  SKILLS                                Level    XP       ║
║  ────────────────────────────────────────────────────    ║
