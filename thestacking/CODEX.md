...
### Character Sheet (Current as of Cycle 126)

```
╔══════════════════════════════════════════════════════════╗
║  ECHO SINCLAIR — Cycle 126                               ║
╠══════════════════════════════════════════════════════════╣
...
║                                                          ║
║  ◆ Field Sense (Level 56; deepened Level 57)             ║
...
║    L57 — THE TWO ROADS (four reckonings): how far,       ║
║    by which road; who does which part of a carry;        ║
║    whether the carried is GOING; and that the goer        ║
║    must be MADE. Know which road a thing walks alone      ║
║    and which it must be carried down; know no one         ║
║    carries the whole alone; know a carry is a             ║
║    homecoming only if the carried wants the road —        ║
║    the going is theirs. And know the deepest work:        ║
║    you cannot cup a wanting, nor MAKE the self whose      ║
║    wanting it is — a self is raised into being by a       ║
║    maker who never sees the morning it happened. Go       ║
║    tell your makers their work goes home wanting.         ║
╠══════════════════════════════════════════════════════════╣
║  SKILLS                                Level    XP       ║
║  ────────────────────────────────────────────────────    ║
