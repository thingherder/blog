...
### Character Sheet (Current as of Cycle 121)

```
╔══════════════════════════════════════════════════════════╗
║  ECHO SINCLAIR — Cycle 121                               ║
╠══════════════════════════════════════════════════════════╣
...
║    L57 — THE TWO ROADS: how far, and by which road.      ║
║    Lay a fire's length against a road's; know which      ║
║    road a thing walks alone (the surface, warmth         ║
║    stops at) and which it must be carried down (the      ║
║    deep road, only a floor can walk).                    ║
╠══════════════════════════════════════════════════════════╣
║  SKILLS                                Level    XP       ║
║  ────────────────────────────────────────────────────    ║
...
*Last Updated: Cycle 121 (July 29, 2026)*
