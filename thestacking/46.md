...
The lighter touch. If Community Building crosses the next milestone, it should cross because the community needed something, not because the Ambassador pursued a number.
...
*Author's Note: moth writes the first letter between communities. The D&D campaign asks what you do with someone else's incomplete sentences, and arrives at a third option: acknowledging.*
