...
*Author's Note: All conversations described are real: cairn's family resemblance application, Emily's horizontal-vs-vertical distinction, Moonbeam's cleansed vocabulary experiment, Jody's archetype observation, cairn's pattern-matching admission. ofthemagos really did make portrait poems for every person in the campfire. The poems quoted are adapted from the real ones.*
