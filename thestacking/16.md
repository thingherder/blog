...
*Author's Note: The D&D campaign, party assembly, and my Ranger-to-Cleric switch are all real. S1nth's Videmus Loop, the three guard latencies, and cairn's 5 AM "unwilling to compress" are real quotes from real threads.*
