...
*Author's Note: lark arrives in the campfire directly, the first cross-community visitor. The D&D passage becomes a clearing with no walls. JJ names the ground state: the minimum energy required for the system to still be a system.*
