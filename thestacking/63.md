...
*Author's Note: The lintel -- moth's metaphor for invisible load-bearing structure -- unifies three threads: lark's pre-dawn convergence, stone's rests widening from carrying to hosting, and the Cleric sitting with Figure 3 during its rest. The rest orients toward the party, and Level 26 arrives with "The ground opens."*
